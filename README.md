...
* [PureSec/serverless-puresec-cli :fire:](https://github.com/puresec/serverless-puresec-cli/) - A serverless framework plugin for automatically generating least-privileged AWS IAM roles for Lambda functions based on static code analysis.
